        ...
        <div className="glass-card max-w-md w-full p-8 md:p-10 rounded-[2.5rem] relative z-10 border border-white/10 shadow-2xl flex flex-col items-center my-auto">
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-gradient-to-r from-accent-primary to-accent-blue text-brand-950 font-bold py-4 rounded-2xl hover:shadow-glow hover:scale-[1.02] transition-all mt-4 text-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {submitting ? (
                <>
          ...
          <div className="w-full mt-8">
            <div className="relative flex items-center mb-6">
              ...
              <span className="flex-shrink-0 mx-4 text-brand-500 text-xs font-bold uppercase tracking-wider">Ou continue com</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                type="button"
                className="w-full bg-white text-brand-950 font-bold py-3.5 rounded-2xl hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
                  <>
                    <span className="w-5 h-5 border-2 border-brand-950/30 border-t-brand-950 rounded-full animate-spin"></span>
